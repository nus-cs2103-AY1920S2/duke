        ...
        try{
            ...
            while(line != null){
                ...
                if(action.equals("Todo")){
                    ...
                    destination.add(new Deadlines(tempArray[2], tempArray[3],tempArray[0]));
                }
                else {
                    destination.add(new Events(tempArray[2], tempArray[3],tempArray[0]));
                }
                line = br.readLine();
            }
