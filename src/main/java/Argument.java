...
public class Argument {
     ...
     * @throws DukeException If the command keyword (the first word) is invalid.
     */
     ...
     * @throws DukeException If the argument is not a valid argument.
     */

    public void checkValidListArgument() throws DukeException {
        if (!this.details.equals("")) {
            throw new DukeException("☹ OOPS!!! The argument for 'list' command is invalid.");
        }
    }
     ...
     * @throws DukeException If the argument is not valid.
     */

    public int checkValidDoneArgument() throws DukeException {
        int index = -1;
        try {
            index = Integer.parseInt(this.details);
        } catch (NumberFormatException e) {
            throw new DukeException("☹ OOPS!!! The argument for 'done' command requires a number.");
        }
        return index;
    }
    ...
    public int checkValidDeleteArgument() throws DukeException {
        int index = -1;
        try {
            index = Integer.parseInt(this.details);
        } catch (NumberFormatException e) {
            throw new DukeException("☹ OOPS!!! The argument for 'delete' command requires a number.");
        }
        return index;
    }
    ...
    public String checkValidTodoArgument() throws DukeException {
        if (this.details.equals("")) {
            throw new DukeException("☹ OOPS!!! The argument for 'todo' command requires a description");
        }
        return this.details;
    }
    ...
    public Pair<String, String> checkValidDeadlineArgument() throws DukeException {
        String caption;
        String by_schedule;
        ...
        try {
            ...
            throw new DukeException("☹ OOPS!!! The argument for 'deadline' " +
    ...
    public Pair<String, String> checkValidEventArgument() throws DukeException {
        String caption;
        String by_schedule;
        ...
        try {
            ...
            throw new DukeException("☹ OOPS!!! The argument for 'event' " +
