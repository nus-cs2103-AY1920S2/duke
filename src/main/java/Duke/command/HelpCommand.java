...
public class HelpCommand extends Command {
    ...
    private static final String DETAILED_COMMANDS = HORIZONTAL_BORDER + "General Commands\n"
            ...
            + HORIZONTAL_BORDER + "Find Command\nCommand format:\nFIND KEYWORD\n(eg. find assignment)\n\n"
            + HORIZONTAL_BORDER  + "Add Task Commands(w/o date and time)\nCommand format:\nTASKTYPE DESCRIPTION\n"
            + "(eg. todo read)\n\n" + "TASKTYPE:\ntodo\n\n" + HORIZONTAL_BORDER
            + "Add Task Commands(with date and time)\n"
            ...
            + "TASKTYPE:\ndeadline\nevent\n\n" + HORIZONTAL_BORDER
            + "Note: All input commands are non case-sensitive.\n"
            + HORIZONTAL_BORDER;
