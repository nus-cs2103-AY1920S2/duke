...
public class UI {
    ...
    public void greetUser() {
        ...
        System.out.println("4) event [taskname] /at [datetime]: Add an event "
                + "with a taskname together with the date/time!");
        System.out.println("5) deadline [taskname] /by [date time] (DD-MM-YYYY HH:mm format eg: 31-12-2020 23:59): "
                + "Add an deadline with a taskname together with the date/time!");
    }
