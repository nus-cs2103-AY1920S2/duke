...
public class Messages {
    ...
    public static final String DELETE_INVALID_TASK_INDEX_MESSAGE = "Oops Chidi! I think you gave me the wrong task index! "
    ...
    public static final String DONE_INVALID_TASK_INDEX_MESSAGE = "Oops Chidi! I think you gave me the wrong task index! "
        + "Please refer to the 'list' command for available indices.";
    public static final String DONE_SUCCESS_MESSAGE = "Well done Chidi! You should give yourself a pat! "
        + "Meanwhile, I've marked this task as done: \n%s";
    ...
    public static final String FIND_SUCCESS_MESSAGE = "Yeah! Found some tasks! Here they are!\n %s";

    // Others
    public static final String STORAGE_SAVE_ERROR_MESSAGE = "Oh no! An error happened while I was writing to the storage file!\n"
