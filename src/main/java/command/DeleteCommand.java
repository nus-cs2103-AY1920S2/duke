...
/**
 * Represents a command where done is called which changes the boolean isCheck value.
 * A <code>DoneCommand</code> corresponds to when a task is complete with id of e.g. <code>2</code>
 */
