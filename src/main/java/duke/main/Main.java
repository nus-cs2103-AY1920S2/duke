...
public class Main extends Application {
     ...
     */
    private void handleUserInput() throws OutOfBoundMarkingRequestException, TaskErrorException, InvalidCommandException {
    ...
    private String getResponse(String userInput) throws OutOfBoundMarkingRequestException, TaskErrorException, InvalidCommandException {
        if (userInput.equals(Duke.BYE_COMMAND))
            return bot.byeBye();
        if (userInput.equals(Duke.LIST_COMMAND)) {
            return bot.listStoredItems();
        }

        return bot.processUserInput(userInput);
    }
}
