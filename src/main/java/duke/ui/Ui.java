...
public class Ui {
     ...
     */
    public static String generateAddMessage(String[] details) {
     ...
     */
    public static String generateDeleteMessage(String[] details) {
     ...
     */
    public static String generateDoneMessage(String details) {
     ...
     */
    public static String generateListMessage(ArrayList<Task> tasks) {
     ...
     */
    public static String generateMatchingListMessage(ArrayList<Task> tasks) {
     ...
     */
    public static String generateUndoMessage(ArrayList<Task> tasks) {
