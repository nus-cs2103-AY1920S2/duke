...
public class ExceptionGenerator {
    ...
    /**
     * Check if the dscription is only 1 word.
     * @param description the user's input.
     */
    public static void checkDescription(String description) {
        String[] tokkens = description.split(" ");
        if (tokkens.length > 1) {
            throw new DukeException("Please keep your description to one word. ^.^");
        }
    }
    /**
     ...
     * @param date refers to the dateline of the task for event and deadlines.
