...
public class DeadlineTask extends Task {
    ...
    /**
     * Stores deadline associated with deadline task.
     **/
     ...
     */
    public DeadlineTask(final String description, final String deadline)
    ...
    public String format() {
        return "D | "
                + super.format()
                + " | "
                + DateTimeFormatter.ofPattern("dd/MM/yyyy HHmm").format(this.by);
    }
}
