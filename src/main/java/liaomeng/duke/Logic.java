...
/**
 * The class that executes the instruction based on parsed user input
 * and returns respective response or error message.
 */
public class Logic {
    ...
    /**
     * Calls respective method based on the instruction wor (the first word of String array instructionByWord),
     * and returns response message. If any error occurs (for example invalid instruction word,
     * invalid input format for the instruction, empty input), returns the error message.
     *
     * @param instructionByWord String array containing the user input, split by white space (i.e. " ").
    ...
    private String assignPriorityToTask(String priorityLevel, int index) throws DukeException {
        ...
        return tasks.assignPriorityToTask(index, level);
    }
