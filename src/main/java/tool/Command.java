    ...
    switch (command) {
      ...
      case "deadline":
        if (!arguments.contains("/by ")) {
          ...
          ui.printError(
              "☹ OOPS!!! Follow the format: deadline [activity] /by [year]-[month]-[day] [hour]:[minute]");
        } else {
      ...
      case "event":
        if (!arguments.contains("/at ")) {
          ...
          ui.printError(
              "☹ OOPS!!! Follow the format: event [activity] /at [year]-[month]-[day] [hour]:[minute] to [year]-[month]-[day] [hour]:[minute]");
        } else {
          String description = arguments.split("/")[0].trim();
          ...
          String newDateTime1 =
              datetimeParsed1.format(DateTimeFormatter.ofPattern("dd MMM yyyy HH:mma"));
          String newDateTime2 =
              datetimeParsed2.format(DateTimeFormatter.ofPattern("dd MMM yyyy HH:mma"));
