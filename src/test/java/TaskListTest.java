...
public class TaskListTest {
    ...
    public void createEvent_noAt_exceptionThrown() {
        try {
            assertEquals(new Event("description", "2020-01-01", "1000"),
                    TaskListStub.createEvent("event description /at"));
            fail();
        } catch (GooseIllegalFormatException e) {
    ...
    public void testCreateEvent() {
        try {
            assertEquals("[E][N] description (at: Jan 1 2020, 10.00am)",
                    TaskListStub.createEvent("event description /at 1/1/2020 1000").toString());
