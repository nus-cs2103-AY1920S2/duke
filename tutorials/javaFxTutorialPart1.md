...
Next, we create another Java class, `duke.Launcher`, as an entry point to our application.
The `duke.Launcher` class is reproduced below in its entirety.
...
Run `duke.Launcher` and you should see something like this:
