...
Next, we create another Java class, `dukeApp.duke.Launcher`, as an entry point to our application.
The `dukeApp.duke.Launcher` class is reproduced below in its entirety.
 ...
 */
public class dukeApp.duke.Launcher {
    public static void main(String[] args) {
        Application.launch(dukeApp.duke.Duke.class, args);
    }
}
```

Run `dukeApp.duke.Launcher` and you should see something like this:
