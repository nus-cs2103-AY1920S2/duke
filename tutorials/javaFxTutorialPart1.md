...
Next, we create another Java class, `dukebot.Launcher`, as an entry point to our application.
The `dukebot.Launcher` class is reproduced below in its entirety.
...
Run `dukebot.Launcher` and you should see something like this:
