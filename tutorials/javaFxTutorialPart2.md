# JavaFX Tutorial Part 2 - Creating a GUI for duke.duke.Duke

In this tutorial, we will be creating a GUI for duke.duke.Duke from scratch based on the following mockup.

![Mockup for duke.duke.Duke](assets/DukeMockup.png)
...
![duke.duke.Duke's layout](assets/DukeSceneGraph.png) 
...
![duke.duke.Duke's raw layout](assets/RawLayout.png)
...
![duke.duke.Duke's Final layout](assets/FinalLayout.png)
