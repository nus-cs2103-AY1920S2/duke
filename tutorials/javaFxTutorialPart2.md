# JavaFX Tutorial Part 2 - Creating a GUI for Core.Duke

In this tutorial, we will be creating a GUI for Core.Duke from scratch based on the following mockup.

![Mockup for Core.Duke](assets/DukeMockup.png)
...
![Core.Duke's layout](assets/DukeSceneGraph.png) 
...
![Core.Duke's raw layout](assets/RawLayout.png)
...
![Core.Duke's Final layout](assets/FinalLayout.png)
