# JavaFX Tutorial Part 2 - Creating a GUI for dukeApp.duke.Duke

In this tutorial, we will be creating a GUI for dukeApp.duke.Duke from scratch based on the following mockup.

![Mockup for dukeApp.duke.Duke](assets/DukeMockup.png)
...
![dukeApp.duke.Duke's layout](assets/DukeSceneGraph.png) 
...
![dukeApp.duke.Duke's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("dukeApp.duke.Duke");
...
![dukeApp.duke.Duke's Final layout](assets/FinalLayout.png)
