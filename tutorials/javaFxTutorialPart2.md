# JavaFX Tutorial Part 2 - Creating a GUI for dukeproj.Duke

In this tutorial, we will be creating a GUI for dukeproj.Duke from scratch based on the following mockup.

![Mockup for dukeproj.Duke](assets/DukeMockup.png)
...
![dukeproj.Duke's layout](assets/DukeSceneGraph.png) 
...
![dukeproj.Duke's raw layout](assets/RawLayout.png)
...
![dukeproj.Duke's Final layout](assets/FinalLayout.png)
