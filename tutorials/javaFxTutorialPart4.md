...
Let's return to dukeClasses.Duke and convert it to use FXML instead.
...
As part of the effort to separate the code handling dukeClasses.Duke's logic and UI, let's _refactor_ the UI-related code to its own class.
...
public class MainWindow extends AnchorPane {
    ...
    public void setDuke(dukeClasses.Duke d) {
        duke = d;
    }
...
Let's create a new `Main` class as the bridge between the existing logic in `dukeClasses.Duke` and the UI in `MainWindow`.
...
/**
 * A GUI for dukeClasses.Duke using FXML.
 */
public class Main extends Application {

    private dukeClasses.Duke duke = new dukeClasses.Duke();
